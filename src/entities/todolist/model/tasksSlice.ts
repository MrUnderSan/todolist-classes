import {ModelTaskType, taskApi, TaskResponseType} from 'entities/todolist/api/taskApi';
import {AppThunk} from 'app/store/store';
import {createSlice, PayloadAction} from '@reduxjs/toolkit';
import {todolistsThunk} from 'entities/todolist/model/todolistsSlice';
    ...
    async (arg, thunkAPI) => {
        ...
        try {
            ...
            if (response.data.resultCode === 0) {
                ...
                handleServerAppError(dispatch, response.data, appActions.changeAppError)
